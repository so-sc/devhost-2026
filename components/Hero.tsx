    ...
    >
      ...
      >
        <div className="h-full w-full animate-[spin_35s_linear_infinite]">
          <Image
            src="/hero/hero-section-wheel.png"
            alt=""
            fill
            priority
      ...
      >
        ...
        {/* MOBILE SOLDIER LEFT */}
        <Image
          src="/hero/mobile_soldier_left.png"
          alt=""
          width={400}
          height={600}
          priority
      ...
      >
        ...
        <Image
          src="/hero/mobile_soldier_right.png"
          alt=""
          width={400}
          height={600}
          priority
